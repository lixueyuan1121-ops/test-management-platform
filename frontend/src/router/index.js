...
const routes = [
  { path: '/login', name: 'login', component: () => import('@/views/Login.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'eval-tasks', name: 'eval-tasks', component: () => import('@/views/EvalTasks.vue'), meta: { title: '测评任务' } },
      { path: 'verified-imports', name: 'verified-imports', component: () => import('@/views/VerifiedImports.vue'), meta: { title: '导入任务' } },
      ...
      { path: 'device-board', name: 'device-board', component: () => import('@/views/DeviceBoard.vue'), meta: { title: '设备看板' } },
      ...
      { path: 'feedback-results', name: 'feedback-results', component: () => import('@/views/FeedbackResults.vue'), meta: { title: '回归结果' } },
      ...
      { path: 'rts', name: 'rts', component: () => import('@/views/RtsSelect.vue'), meta: { title: '回归智选', platformAdmin: true } },
      { path: 'commander', name: 'commander', component: () => import('@/views/Commander.vue'), meta: { title: '测试指挥官' } },
