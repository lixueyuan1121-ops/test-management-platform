...
CREATE TABLE `exec_run` (
  ...
  KEY `idx_execrun_release` (`release_id`),
  KEY `idx_execrun_retryof` (`retry_of`),
...
CREATE TABLE `eval_run` (
  ...
  `multica_pushed_at` DATETIME NULL,
  `multica_retest_source_id` INT NULL,
  `reason` TEXT NULL,
  ...
  KEY `ix_eval_run_multica_retest_source_id` (`multica_retest_source_id`),
...
CREATE TABLE `eval_task` (
  ...
  `auto_pipeline` TINYINT NOT NULL DEFAULT 0,
  `pipeline_status` VARCHAR(16) NULL,
  `pipeline_at` DATETIME NULL,
