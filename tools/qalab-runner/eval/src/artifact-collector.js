...
function runnerMetadata() {
  ...
  for (const name of ['dialog-runner.js', 'desktop-runner.js', 'workbuddy-runner.js', 'dialog-config.js', 'artifact-collector.js',
    'qwork-runner.js', 'qwork-trace.js', 'qwork-pool.js', 'qwork-native-files.js', 'qwork-batch.js',
    'qwork-permissions.js', 'qwork-share.js', 'product-routing.js']) hash.update(fs.readFileSync(path.join(__dirname, name)));
